...
export class SedeService {
  ...
  async createSede(
    ...
    const sede = await this.prisma.sede.create({
      data: {
        ...
        proveedorActivo: data.proveedorActivo,
        proveedorRuta: data.proveedorRuta,
        proveedorToken: data.proveedorToken,
        proveedorConfig: data.proveedorConfig ?? undefined,
  ...
  private formatSedeDetail(sede: any): SedeDetailDto {
    return {
      ...
      proveedorActivo: sede.proveedorActivo ?? undefined,
      proveedorRuta: sede.proveedorRuta,
      proveedorToken: sede.proveedorToken,
      proveedorConfig: sede.proveedorConfig as Record<string, any> | undefined,
