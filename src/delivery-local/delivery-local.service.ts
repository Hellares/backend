...
export class DeliveryLocalService {
  ...
  // El catálogo lo sirve UbigeoService (compartido con guía de remisión).
  ubigeoDepartamentos() {
    return this.ubigeo.departamentos();
  }

  ubigeoProvincias(departamento?: string) {
    return this.ubigeo.provincias(departamento);
  }

  ubigeoDistritos(provincia?: string) {
    return this.ubigeo.distritos(provincia);
  }
