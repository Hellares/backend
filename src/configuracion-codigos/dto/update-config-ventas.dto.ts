...
export class UpdateConfigVentasDto {
  @ApiPropertyOptional({
    description: 'Prefijo para códigos de ventas (ej: "VTA", "V", "VENTA")',
    example: 'VTA',
    minLength: 1,
    maxLength: 10,
  })
